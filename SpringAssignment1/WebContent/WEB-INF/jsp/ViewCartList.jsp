...
<form:form  method="POST" action="/SpringAssignment1/spring/Remove"> 
<%-- <form:checkbox path="productName" id="" value="${i.productname}" /> --%>
<input type="text" value="${j.productname}" name="productremove"/>
<table>
      <tr>
<!-- 		<th>Product Name</th> -->
<%-- 		<td>${j.productname}</td> --%>
...
<form:form  method="POST" action="/SpringAssignment1/spring/PlaceOrder" >
